...
},
{
  ...
  "body": " How Do We Think About Infinite Series?   Let's consider the following sequence:     White out the first 5 terms of the sequence.    What does this sequence converge to? Show this with a limit!    Now we'll construct a new sequence, this time by adding things up. We're going to be working with the sequence where . Write out the first five terms of this sequence: .    Can you come up with an explicit formula for ?    Does converge or diverge? Use a limit to find what it converges to!    What do you think this means for the infinite series ? Does the infinite series converge or diverge?   "
},
{
  "id": "def-PartialSum",
  "level": "2",
