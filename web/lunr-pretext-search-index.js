...
},
{
  ...
  "body": " Interpreting the Derivative as a Slope   In and , we built the idea of a derivative by calculating slopes and using them. Let's continue this by considering the function .    Use to find . What does this value represent?    Consider the graph of .   Sketch the line that would be tangent to the graph of at .    Remember that we can write the equation of a line in two ways:   The equation of a line with slope that passes through the point is: .    The equation of a line with slope that passes the point (this is another way of saying that the -intercept of the line is ) is: .     Find the equation of the line tangent to at . Add it to the desmos graph above to check your equation.    This tangent line is very similar to the actual curve of the function near . Another way of saying this is that while the slope of is not always the value you found for , it is close to that for -values near .  Use this idea of slope to predict where the -value of our function will be at .   We know that slope is and we're using the fact that for small values of .  Here, we have , so can you use the slope to approximate the corresponding and figure out the new -value?    Compare this value with . How close was it?   "
},
{
...
{
  "id": "subsec-DerivativeProperties-3",
  "level": "2",
  "url": "sec-DerivativeRules.html#subsec-DerivativeProperties-3",
  "type": "Example",
  "number": "2.3.9",
