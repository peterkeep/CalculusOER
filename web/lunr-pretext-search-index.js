...
},
{
  ...
  "number": "4",
  "title": "",
  "body": "  Say we know that and . What do we know (specifically or in general, if anything) about each of the following?          We do not know anything about the value of , including whether or not there is such a value.           The value of should be close to the number . We do not know exactly what the value is, though.           The value of should be close to the number . We do not know exactly what the value is, though.           Since both the left and the right sided limits are the same single, real number (2), so is the limit: .    "
},
{
...
{
  "id": "ex-IntroDerivatives-1",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": " We define a derivative of at as . What is this limit? What does it represent in terms of ? Feel free to sketch some pictures in order to discuss it visually.  "
},
{
  "id": "ex-IntroDerivatives-2",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": " For some function , we have that . What does this mean? Interpret this value in the context of .  "
},
{
  "id": "ex-IntroDerivatives-3",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  For each of the following functions, use the definition of the derivative at a point to find the slope of the line tangent to the function's curve at the specified point.      at        at        at        at        at        at     "
},
{
  "id": "ex-IntroDerivatives-4",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  We have talked about two limit-based definitions of derivatives:      What are some similarities between these definitions? It might help to compare visual depictions of each.      What are some differences between these definitions? Focus on differences in how they are built as well as how we use them.      Pick a situation where it might make sense to use each definition. Explain your choice.    "
},
{
  "id": "ex-IntroDerivatives-5",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  For each of the functions below, find the derivative function , and evaluate that function at , , , and . Interpret these values.                               "
},
{
  "id": "ex-IntroDerivatives-6",
  "level": "2",
  "url": "sec-IntroDerivatives.html#ex-IntroDerivatives-6",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  Find the following derivatives.                                             "
},
{
...
{
  "id": "ex-InterpretingDerivatives-1",
  "level": "2",
  "url": "sec-InterpretingDerivatives.html#ex-InterpretingDerivatives-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "  For each of the following functions, use the definition of the derivative at a point to find and then find the equation of the line tangent to the graph of at .  Remember: The equation of a line given the slope and , a point on the line is .      with        with        with        with        with        with     "
},
{
  "id": "ex-InterpretingDerivatives-2",
  "level": "2",
  "url": "sec-InterpretingDerivatives.html#ex-InterpretingDerivatives-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "  We start watching a car driving down a straight road towards a stop sign. We can tell that their position function is with position measured in feet from their location when we began observing them and time measured in seconds.     How fast is the car driving at ?      How fast is the car driving at ?      At what value of does the car stop (their velocity is 0)?      How far did they travel before they stopped?      At what is the acceleration of the car?      At what is the acceleration of the car?    "
},
{
  "id": "ex-InterpretingDerivatives-3",
  "level": "2",
  "url": "sec-InterpretingDerivatives.html#ex-InterpretingDerivatives-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  The monetary value of an ancient mathematical artifact (the pencil that Isaac Barrow used to prove the Fundamental Theorem of Calculus in 1667) follows the function where is the number of years since 1667 and is the monetary value of the pencil in US Dollars.     What was the overall change in value from 1667 to 1967 (from to ?      What was the average rate of change of the value from 1667 to 1967?      What was the instantaneous rate of change of the value in 1967?      Find and , and interpret both of these values.      Use and to approximate the value of the pencil in 2022.      Use to find the value in 2022. Was the approximation close or not? Explain.    "
},
{
...
{
  "id": "ex-DerivativeRules-1",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "  Consider the following table of values of the derivative for and :                            For each version of , find the derivative indicated.      ; Find        ; Find        ; Find        ; Find     "
},
{
  "id": "ex-DerivativeRules-2",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "  For each of the following functions, find .                                                                         "
},
{
  "id": "ex-DerivativeRules-3",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  We have not yet learned how to differentiate products and quotients of functions.  For each of the following functions including products or quotients, re-write the function and find the derivative.                                                           "
},
{
  "id": "ex-DerivativeRules-4",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  For each of the following functions, find , and then .                 "
},
{
  "id": "ex-DerivativeRules-5",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  For each of the following functions, use to find the equation of the line tangent to at (for the given value of ).      for        for        for        for     "
},
{
  "id": "ex-DerivativeRules-6",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-6",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  Consider the function .     Find the derivative .      Interpret . What does it tell us about ?      Find the value of where the slope of the line tangent to is 6.      Find the value for where has a horizontal tangent line.    "
},
{
  "id": "ex-DerivativeRules-7",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-7",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "  Consider the function .     Find the derivative .      Find the value for where the slope of the line tangent to is 2.      Find the value for where has a vertical tangent line.    "
},
{
  "id": "ex-DerivativeRules-8",
  "level": "2",
  "url": "sec-DerivativeRules.html#ex-DerivativeRules-8",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  Give an example of a function that meets the following requirements.     The equation of the line tangent to the curve at is .      The tangent line is horizontal at , and the function also passes through the point .      The derivative is positive when and negative when .    "
},
{
...
{
  "id": "ex-ProductQuotientRule-1",
  "level": "2",
  "url": "sec-ProductQuotientRule.html#ex-ProductQuotientRule-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": " A student encounters the problem and notes that since and , then . Explain not only why the student is incorrect, but also what kinds of pitfalls can occur if we use this the derivative of a product is the product of the derivatives method. Differentiate correctly, explaining your process for the student's benefit.  "
},
{
  "id": "ex-ProductQuotientRule-2",
  "level": "2",
  "url": "sec-ProductQuotientRule.html#ex-ProductQuotientRule-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "  Consider the following table of values of , , , and .                            Find the following derivatives, using the table.                               "
},
{
  "id": "ex-ProductQuotientRule-3",
  "level": "2",
  "url": "sec-ProductQuotientRule.html#ex-ProductQuotientRule-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  Use the product and quotient rules to differentiate each of the following.                                             This function can be written as .                                "
},
{
  "id": "ex-ProductQuotientRule-4",
  "level": "2",
  "url": "sec-ProductQuotientRule.html#ex-ProductQuotientRule-4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  Differentiate the following.                               "
},
{
  "id": "ex-ProductQuotientRule-5",
  "level": "2",
  "url": "sec-ProductQuotientRule.html#ex-ProductQuotientRule-5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  Find the equation of the line tangent to the function at the given point.      at        at        at        at     "
},
{
  "id": "sec-ChainRule",
  "level": "1",
...
},
{
  "id": "ex-ChainRule-1",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": " For functions and , explain how to use the Chain Rule to find .  "
},
{
  "id": "ex-ChainRule-2",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": " For functions and , explain how to use the Chain Rule to find .  "
},
{
  "id": "ex-ChainRule-3",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": " Explain the differences in the two derivatives above.  "
},
{
  "id": "ex-ChainRule-4",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": " For functions and , explain how to use the Chain Rule to find .  "
},
{
  "id": "ex-ChainRule-5",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  Consider the following table of values of , , and .                                   Find the following derivatives, using the table.                               "
},
{
  "id": "ex-ChainRule-6",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-6",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  Find the following derivatives.                                                    "
},
{
  "id": "ex-ChainRule-7",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-7",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "  Let's introduce a new kind of function: hyperbolic trigonometric functions. For now, let's just defined and (the hyperbolic sine and hyperbolic cosine functions) this way:      Show that .      Show that .      Let . Find .      Find       Find .    "
},
{
  "id": "ex-ChainRule-8",
  "level": "2",
  "url": "sec-ChainRule.html#ex-ChainRule-8",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  Find the following derivatives.                               "
...
{
  "id": "subsec-EventuallyGeometricish-7",
  "level": "2",
...
},
{
  ...
  "body": " Polynomial Approximations of Functions   Before we start, it might be helpful to remind ourselves of the way we have used linear functions to approximate other functions in .    What Do We Want From a Polynomial Approximation?  It's always good to lay out our expectations clearly. We want to make sure that, when we create this new thing , that we have some clear idea of what we're trying to accomplish in its creation. So let's start with our . What were the important properties of this linear function we created?   The function's output, , matched the output from the linear approximation, , at the center .     The function's first derivative, , matched the slope of the linear approximation, , at .    This seems like a good structure! We have , giving us that nice intersection between our approximation and the function we're approximating at the center. Then we used the slope of the function to estimate how our approximating function should move away from that center. The only real problem is that our function probably doesn't have a constant slope, while a constant slope is the defining characteristic of the line we're using.  So how do we extend this, then, into a better approximation? Well, an easy next step is to make the slope of our approximating function change as we move away from the center, . That way, maybe the slopes change in a way that's similar to the slopes of the actual function, and our approximating curve (not a line anymore) can follow the function for a bit longer.  What we're saying is that we want a function where the second derivative is , just like our first derivative matched . Instead of using letters like for linear and for quadratic, let's just call these approximations by their function type (polynomials!) and degree. So , the first-degree polynomial approximation.  Now, to find , we're going to add a term to the first-degree polynomial: Let's differentiate this function twice, and force it to match at . What do we need to fill in the blank to make this match ? So we get: . What if we wanted a higher degree? Like, ? Let's repeat the same process and see what happens! If we, again, want this third derivative to match (so that the rate at which the slope changes as we move away from the center changes in the same way that it does on ...whew, that is going to be hard to interpret!), then we need to fill the blank in with .    How Do We Build a Polynomial Approximation?  Let's jump into a generalization of what we've just done. Answer these few questions with yourself, just to make sure you can see where we're going:   Why, in the coefficients for each term, do we have the derivative that matches the degree of the term? (First derivative for the first degree term, second derivative for the second degree term, and third derivative for the third degree term.)    Why, in the coefficients for each term, do we divide? What are we dividing by, and why do we need these numbers specifically?    If we add a 4th, 5th, and 6th term, what will we divide those 4th, 5th, and 6th derivatives ( , , and ) by?      Polynomial Approximation   If is a function that is -times differentiable at (that is, the function\/derivative values , , , ..., all exist), then the th degree polynomial approximation of centered at is:      Build a Polynomial   We're going to use the formula in to construct two different polynomials that approximate two different approximations. Then, we'll use them to approximate things!     We're going to start with approximating the function centered at . Let's choose to look at a 5th degree polynomial.  This means we'll need to find the first five derivatives of . Then, we'll evaluate our function and the five derivatives at the center. After that, we can divide by the relevant factorial in order to create the coefficients of our polynomial.  Fill out the following chart to produce these coefficients.   Coefficients for Polynomial Approximation                                                   Now we can use these coefficients to construct the polynomial! These coefficients should all be on power functions in the form for . These (added together) will form your polynomial, .      Approximate using your polynomial.      Let's repeat this for another function. Let's build a 5th degree polynomial approximation of centered at . We can construct the coefficients in the same way.   Coefficients for Polynomial Approximation                                                   And now, again, we can use these coefficients to construct the polynomial! These coefficients should all be on power functions in the form for . These (added together) will form your polynomial, .      Approximate using your polynomial.     Now that we know how to build and use these, we should probably think about accuracy. Are the estimations coming from these polynomials even accurate? How do we talk about that?  We won't formally define this too much for now: instead, we'll just look at things visually and see if we can figure out what might go into how we talk about accuracy of our estimations.   How Good Are Our Approximations?   We're going to think more carefully about our approximations of and from . In order for us to do this, let's visualize the function and the 5th degree polynomial for it.      How good of a job did the polynomial approximation do when approximating ? How can you tell, visually?      How good of a job did the polynomial approximation do when approximating ? How can you tell, visually?      How does the relationship between the center and the -value that we're approximating at impact the accuracy of our approximation?      How do you think you could make these approximations better (without changing the center)?     So we have a couple of main ideas about the accuracy of our approximations. We don't need to formalize them, but we can use them as a guiding rule for how we talk about these polynomial approximations.   Accuracy in Polynomial Approximations     Approximations using -values closer to the center are likely to be more accurate than approximations using -values farther away from the center.    Polynomials with larger degrees give more accurate approximations than polynomials with smaller degrees at the same -values.        Are These Partial Sums?  We have been using some familiar language here...we're talking about these approximations improving as we increase some parameter, . We have some intuition that when we increase , these approximations approach an object (in this case, a function) in some sense.  We're adding more and more terms to this sum as we increase . Is a polynomial approximation just a partial sum?  Are we just going to look at a limit as and see what happens?   Partial Sums of What?   Let's revisit our 5th degree polynomial approximations from . These approximations work well for -values that are close to 0, but we will not be more formal than that.     Make a conjecture about what the 7th degree polynomial approximations are for each of these functions.  What about the 15th degree?      Make a conjecture about what the general formula would be for these terms. If you were to write these out using summation notation, what would they look like?      Why does the polynomial approximation for the sine function only have odd-exponent terms?      Make a conjecture about what a polynomial approximation for centered at would be.     We'll explore these polynomials more, but we're specifically interested in the infinite-series version of these things. For now, let's think about convergence a bit.   How Do These Polynomials Converge?   We're going to end here by thinking about these polynomials as some partial sum from an infinite series. If there is an infinite series, we should be prepared to think about convergence!  We're going to think about convergence in the same way that we have already: as an end behavior limit of the partial sums. So let's spend our time investigating this end behavior by visualizing polynomial approximations as the degree increases.      What happens to the polynomial approximation of centered at as the degree ?      Does this behavior change if we centered our approximation elsewhere?      What happens to the polynomial approximation of centered at as the degree ?      Does this behavior change if we centered our approximation elsewhere?      What happens to the polynomial approximation of centered at as the degree ?      Does this behavior change if we centered our approximation elsewhere?      What happens to the polynomial approximation of centered at as the degree ?      Describe the difference in what you're seeing with the log function compared to the other functions we've thought about. Describe how the polynomial approximations converge: do they converge to the log function? How? More importantly, where ?      Does this behavior change if we centered our approximation elsewhere?     Ok, so this is pretty interesting! For some functions, like , , and , it seems like the polynomials that we built will end up matching (converging to) the functions pretty much everywhere: as we can get any function value from the polynomial, approximated to whatever accuracy we'd like!  But that's different for the log function. We were only able to get our polynomial to match the function's behavior on a specific interval of -values. No matter how high the degree of the polynomial was, we weren't able to get it close to approximating something like , for instance. Unless we changed the center, of course!  This is going to bring up some great questions about how these partial sums converge to functions. We'll talk all about that in the next section!   "
},
{
  ...
  "body": " Polynomial Approximation   If is a function that is -times differentiable at (that is, the function\/derivative values , , , ..., all exist), then the th degree polynomial approximation of centered at is:    "
},
{
...
{
  "id": "thm-OperationsPowerSeries",
  "level": "2",
  "url": "sec-PowerSeriesConvergence.html#thm-OperationsPowerSeries",
  "type": "Theorem",
  "number": "9.2.4",
  "title": "Operations on Power Series.",
  "body": " Operations on Power Series   For two power series and that converge to and (respectively) on the interval of convergence , we can consider the following operations to combine power series.      Sum:  converges to on .     Difference:  converges to on .     Product: If is a power function, then converges to on .     Composition: If is a power function, then converges to on .      "
},
{
  "id": "thm-DiffPowerSeries",
  "level": "2",
...
{
  "id": "subsec-OperationsPowerSeries-5",
  "level": "2",
...
{
  "id": "subsec-OperationsPowerSeries-7",
  "level": "2",
  "url": "sec-PowerSeriesConvergence.html#subsec-OperationsPowerSeries-7",
  "type": "Example",
  "number": "9.2.7",
  "title": "",
  "body": "  Let's re-consider the power series . We know, from , that this power series converges to for -values in the interval .     Find a power series that converges to . What is the interval of convergence?     The interval of convergence doesn't change: .      Find a power series that converges to . What is the interval of convergence?     The interval of convergence is .      Find a power series that converges to . What is the interval of convergence?     Since is in the coefficient, starting the index at means that the first term is 0: we can re-index if we'd like, but it is not necessary. In any of these cases, the interval of convergence is .    "
},
{
