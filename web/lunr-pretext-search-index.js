...
},
{
  ...
  "number": "8.4.8",
  "title": "",
  "body": "  For each of the following infinite series, decide whether it is possible (and reasonable) to use the Integral Test. If it is, apply the test and interpret the conclusions.         "
},
{
